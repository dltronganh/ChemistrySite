...
class BlogSeries(models.Model):
    ...
    blog_category = models.ForeignKey(BlogCategory, default = True, verbose_name="Category",on_delete=models.SET_DEFAULT)
...
class Blog(models.Model):
    ...
    blog_series = models.ForeignKey(BlogSeries, default = True ,verbose_name="Series", on_delete=models.SET_DEFAULT)
